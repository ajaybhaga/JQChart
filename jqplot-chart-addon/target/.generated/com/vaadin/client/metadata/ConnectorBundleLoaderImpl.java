...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.TwinColSelect","com.vaadin.ui.Slider","com.vaadin.ui.MenuBar","com.vaadin.ui.Table","com.vaadin.server.BrowserWindowOpener","com.vaadin.server.FileDownloader","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.ListSelect","com.cs.Chart","com.vaadin.ui.JavaScript","com.vaadin.ui.InlineDateField","com.vaadin.ui.GridLayout","com.vaadin.ui.DateField","com.vaadin.ui.Flash","com.vaadin.ui.PasswordField","com.vaadin.ui.Label","com.vaadin.ui.CustomLayout","com.vaadin.ui.CustomField","com.vaadin.ui.Audio","com.vaadin.ui.Embedded","com.vaadin.ui.Window","com.vaadin.ui.Image","com.vaadin.ui.CustomComponent","com.vaadin.ui.Form","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.NativeButton","com.vaadin.ui.UI","com.vaadin.ui.VerticalLayout","com.vaadin.ui.OptionGroup","com.vaadin.ui.TextField","com.vaadin.ui.HorizontalLayout","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.FormLayout","com.vaadin.ui.TextArea","com.vaadin.ui.Button","com.vaadin.ui.CheckBox","com.vaadin.ui.Video","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.TabSheet","com.vaadin.ui.NativeSelect","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.ComboBox","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Tree","com.vaadin.ui.Link","com.vaadin.ui.Upload","com.vaadin.ui.PopupView","com.vaadin.ui.Panel","com.vaadin.ui.TreeTable","com.vaadin.ui.BrowserFrame","com.vaadin.ui.CssLayout","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Accordion",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"registeredEventListeners", "enabled", "resources", "names", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"primaryStyleName", "orientation", "required", "registeredEventListeners", "enabled", "width", "maxValue", "modified", "tabIndex", "immediate", "styles", "value", "hideErrors", "minValue", "propertyReadOnly", "resources", "height", "errorMessage", "id", "caption", "description", "resolution", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"errorMessage", "styles", "primaryStyleName", "registeredEventListeners", "description", "height", "immediate", "childCss", "caption", "id", "resources", "readOnly", "enabled", "width", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"resources", "registeredEventListeners", "required", "height", "enabled", "description", "caption", "readOnly", "id", "hideErrors", "primaryStyleName", "immediate", "tabIndex", "width", "modified", "errorMessage", "textFieldEnabled", "propertyReadOnly", "styles", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"registeredEventListeners", "immediate", "errorMessage", "readOnly", "height", "resources", "id", "width", "description", "styles", "primaryStyleName", "caption", "enabled", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"enabled", "id", "registeredEventListeners", "primaryStyleName", "caption", "styles", "height", "description", "errorMessage", "readOnly", "immediate", "resources", "width", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"tabIndex", "immediate", "primaryStyleName", "caption", "resources", "readOnly", "hideErrors", "errorMessage", "id", "modified", "height", "enabled", "propertyReadOnly", "required", "registeredEventListeners", "width", "description", "styles", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"required", "tabIndex", "height", "modified", "resources", "id", "propertyReadOnly", "caption", "registeredEventListeners", "immediate", "width", "hideErrors", "styles", "readOnly", "enabled", "primaryStyleName", "errorMessage", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"primaryStyleName", "description", "readOnly", "hideErrors", "height", "resources", "immediate", "width", "tabIndex", "modified", "styles", "registeredEventListeners", "required", "propertyReadOnly", "id", "enabled", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"tabIndex", "columns", "text", "primaryStyleName", "inputPrompt", "propertyReadOnly", "hideErrors", "resources", "errorMessage", "id", "styles", "required", "rows", "wordwrap", "maxLength", "enabled", "description", "caption", "modified", "width", "height", "registeredEventListeners", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"height", "registeredEventListeners", "styles", "errorMessage", "readOnly", "description", "caption", "immediate", "id", "enabled", "primaryStyleName", "width", "resources", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"enabled", "caption", "modified", "errorMessage", "required", "width", "immediate", "styles", "id", "description", "text", "propertyReadOnly", "primaryStyleName", "tabIndex", "inputPrompt", "hideErrors", "readOnly", "columns", "registeredEventListeners", "resources", "maxLength", "height", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"required", "registeredEventListeners", "description", "tabIndex", "readOnly", "errorMessage", "id", "enabled", "hideErrors", "caption", "styles", "immediate", "modified", "height", "width", "resources", "propertyReadOnly", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"enabled", "resources", "description", "styles", "width", "secondChild", "primaryStyleName", "firstChild", "errorMessage", "registeredEventListeners", "immediate", "height", "readOnly", "caption", "id", "splitterState", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"enabled", "modified", "immediate", "hideErrors", "errorMessage", "id", "height", "readOnly", "resources", "required", "checked", "tabIndex", "styles", "propertyReadOnly", "primaryStyleName", "caption", "width", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"errorMessage", "registeredEventListeners", "readOnly", "primaryStyleName", "muted", "sources", "sourceTypes", "immediate", "resources", "description", "enabled", "autoplay", "caption", "htmlContentAllowed", "altText", "height", "id", "width", "showControls", "styles", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"registeredEventListeners", "primaryStyleName", "state", "pollingInterval", "hideErrors", "width", "styles", "required", "enabled", "errorMessage", "caption", "modified", "id", "resources", "propertyReadOnly", "height", "indeterminate", "readOnly", "tabIndex", "description", "immediate", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"enabled", "caption", "errorMessage", "callbackNames", "primaryStyleName", "resources", "height", "styles", "registeredEventListeners", "description", "immediate", "readOnly", "rpcInterfaces", "width", "id", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"clientY", "relativeX", "altKey", "clientX", "relativeY", "button", "shiftKey", "ctrlKey", "metaKey", "type", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "callbackNames", "rpcInterfaces", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"height", "errorMessage", "styles", "caption", "parameters", "id", "description", "features", "readOnly", "resources", "enabled", "target", "registeredEventListeners", "width", "immediate", "uriFragment", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"contentMode", "description", "errorMessage", "height", "resources", "readOnly", "enabled", "immediate", "caption", "styles", "id", "width", "primaryStyleName", "registeredEventListeners", "text", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"disableOnClick", "registeredEventListeners", "caption", "errorMessage", "height", "id", "tabIndex", "width", "styles", "clickShortcutKeyCode", "htmlContentAllowed", "enabled", "immediate", "primaryStyleName", "readOnly", "resources", "description", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"propertyReadOnly", "caption", "readOnly", "width", "tabIndex", "description", "resources", "required", "hideErrors", "registeredEventListeners", "styles", "modified", "immediate", "height", "id", "enabled", "errorMessage", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"description", "resources", "caption", "primaryStyleName", "registeredEventListeners", "classId", "enabled", "errorMessage", "standby", "readOnly", "alternateText", "height", "codebase", "archive", "styles", "id", "codetype", "width", "immediate", "embedParams", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"width", "primaryStyleName", "caption", "styles", "enabled", "errorMessage", "description", "childLocations", "templateName", "registeredEventListeners", "templateContents", "resources", "immediate", "readOnly", "height", "id", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"height", "alternateText", "immediate", "errorMessage", "resources", "primaryStyleName", "styles", "enabled", "width", "registeredEventListeners", "readOnly", "caption", "description", "id", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "column1", "row2", "row1", "column2", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"errorMessage", "height", "hideErrors", "caption", "styles", "propertyReadOnly", "tabIndex", "immediate", "readOnly", "resources", "description", "enabled", "id", "primaryStyleName", "required", "modified", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"htmlContentAllowed", "autoplay", "description", "resources", "caption", "primaryStyleName", "errorMessage", "id", "altText", "sources", "width", "styles", "muted", "registeredEventListeners", "enabled", "readOnly", "sourceTypes", "showControls", "height", "immediate", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"readOnly", "width", "id", "height", "tabIndex", "scrollTop", "errorMessage", "registeredEventListeners", "scrollLeft", "enabled", "styles", "primaryStyleName", "description", "resources", "immediate", "caption", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"tabIndex", "resources", "modified", "primaryStyleName", "errorMessage", "width", "enabled", "immediate", "styles", "required", "registeredEventListeners", "description", "height", "readOnly", "caption", "propertyReadOnly", "hideErrors", "id", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"errorMessage", "registeredEventListeners", "immediate", "readOnly", "primaryStyleName", "id", "width", "height", "enabled", "caption", "description", "styles", "resources", });
            store.setProperties(com.cs.gwt.client.shared.JQChartState.class, new String[] {"uuid", "clickJS", "dataClickJS", "chartHeight", "id", "chartWidth", "description", "height", "registeredEventListeners", "errorMessage", "frameHeight", "styles", "refreshJS", "readOnly", "enabled", "frameWidth", "initJS", "resources", "primaryStyleName", "caption", "immediate", "width", });
            ...
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"primaryStyleName", "height", "registeredEventListeners", "rows", "spacing", "enabled", "styles", "resources", "childData", "columns", "description", "marginsBitmask", "errorMessage", "caption", "immediate", "readOnly", "id", "width", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"enabled", "width", "resources", "marginsBitmask", "primaryStyleName", "childData", "height", "caption", "readOnly", "description", "registeredEventListeners", "id", "styles", "spacing", "immediate", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"registeredEventListeners", "width", "height", "errorMessage", "readOnly", "description", "primaryStyleName", "marginsBitmask", "childData", "enabled", "resources", "styles", "id", "spacing", "caption", "immediate", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"registeredEventListeners", "enabled", "width", "description", "spacing", "styles", "readOnly", "height", "resources", "caption", "primaryStyleName", "id", "childData", "errorMessage", "marginsBitmask", "immediate", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPositionUnit", "position", "maxPosition", "minPosition", "positionUnit", "positionReversed", "locked", "minPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"description", "centered", "errorMessage", "modal", "scrollLeft", "resizeLazy", "id", "resizable", "positionX", "scrollTop", "width", "tabIndex", "positionY", "styles", "caption", "immediate", "enabled", "primaryStyleName", "registeredEventListeners", "draggable", "readOnly", "resources", "height", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"tabIndex", "immediate", "caption", "registeredEventListeners", "primaryStyleName", "resources", "enabled", "description", "id", "height", "width", "readOnly", "styles", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"width", "enabled", "description", "resources", "id", "styles", "immediate", "errorMessage", "caption", "readOnly", "height", "alternateText", "registeredEventListeners", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"enabled", "registeredEventListeners", "resources", "errorMessage", "primaryStyleName", "styles", "immediate", "width", "readOnly", "id", "alternateText", "description", "caption", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"resources", "errorMessage", "enabled", "immediate", "caption", "readOnly", "registeredEventListeners", "primaryStyleName", "splitterState", "width", "height", "description", "styles", "secondChild", "firstChild", "id", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "clickShortcutKeyCode", "height", "registeredEventListeners", "id", "htmlContentAllowed", "caption", "description", "immediate", "enabled", "errorMessage", "width", "readOnly", "styles", "disableOnClick", "tabIndex", "resources", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"id", "caption", "registeredEventListeners", "enabled", "width", "height", "errorMessage", "styles", "connectorToCssPosition", "immediate", "primaryStyleName", "readOnly", "description", "resources", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"immediate", "footer", "hideErrors", "primaryStyleName", "styles", "width", "errorMessage", "required", "resources", "tabIndex", "enabled", "propertyReadOnly", "modified", "height", "caption", "id", "layout", "registeredEventListeners", "description", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"immediate", "registeredEventListeners", "id", "resources", "caption", "description", "errorMessage", "readOnly", "primaryStyleName", "height", "width", "html", "styles", "enabled", "hideOnMouseOut", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"propertyReadOnly", "readOnly", "hideErrors", "modified", "resources", "enabled", "registeredEventListeners", "description", "tabIndex", "height", "errorMessage", "required", "primaryStyleName", "immediate", "caption", "width", "styles", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"immediate", "readOnly", "registeredEventListeners", "cursorY", "resources", "cursorX", "id", "height", "enabled", "bgColor", "description", "caption", "errorMessage", "styles", "primaryStyleName", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"color", "width", "immediate", "styles", "registeredEventListeners", "caption", "height", "resources", "readOnly", "enabled", "errorMessage", "showDefaultCaption", "htmlContentAllowed", "id", "primaryStyleName", "popupVisible", "description", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"registeredEventListeners", "errorMessage", "readOnly", "description", "changedY", "caption", "changedX", "columnCount", "width", "immediate", "changedColor", "primaryStyleName", "rowCount", "height", "styles", "enabled", "id", "resources", });
