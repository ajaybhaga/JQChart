...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.TreeTable","com.vaadin.ui.TextArea","com.vaadin.ui.Embedded","com.vaadin.ui.Video","com.vaadin.ui.InlineDateField","com.vaadin.ui.MenuBar","com.vaadin.server.FileDownloader","com.vaadin.ui.CustomLayout","com.vaadin.ui.NativeSelect","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Audio","com.vaadin.ui.Panel","com.vaadin.ui.ComboBox","com.vaadin.ui.CustomComponent","com.vaadin.ui.TextField","com.vaadin.ui.Button","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.UI","com.vaadin.ui.Accordion","com.vaadin.ui.DateField","com.vaadin.ui.Upload","com.vaadin.ui.OptionGroup","com.vaadin.ui.FormLayout","com.vaadin.ui.JavaScript","com.vaadin.ui.NativeButton","com.vaadin.ui.Link","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.VerticalLayout","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Image","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Label","com.vaadin.ui.ListSelect","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.PopupView","com.vaadin.ui.Slider","com.vaadin.ui.BrowserFrame","com.vaadin.ui.TwinColSelect","com.cs.Chart","com.vaadin.ui.Form","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.CssLayout","com.vaadin.ui.TabSheet","com.vaadin.ui.GridLayout","com.vaadin.ui.Window","com.vaadin.ui.CustomField","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.Tree","com.vaadin.ui.Table","com.vaadin.ui.CheckBox","com.vaadin.ui.Flash","com.vaadin.ui.PasswordField","com.vaadin.ui.VerticalSplitPanel",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"resources", "registeredEventListeners", "spacing", "marginsBitmask", "childData", "immediate", "height", "errorMessage", "width", "primaryStyleName", "id", "styles", "enabled", "readOnly", "caption", "description", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"propertyReadOnly", "resources", "height", "modified", "description", "required", "width", "value", "immediate", "id", "tabIndex", "enabled", "hideErrors", "styles", "resolution", "orientation", "maxValue", "minValue", "caption", "errorMessage", "registeredEventListeners", "primaryStyleName", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"modified", "caption", "primaryStyleName", "propertyReadOnly", "immediate", "hideErrors", "resources", "required", "errorMessage", "height", "registeredEventListeners", "description", "styles", "id", "readOnly", "enabled", "width", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"immediate", "id", "hideErrors", "readOnly", "errorMessage", "tabIndex", "styles", "height", "enabled", "required", "registeredEventListeners", "caption", "primaryStyleName", "resources", "width", "textFieldEnabled", "propertyReadOnly", "modified", "description", });
            ...
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"height", "templateName", "width", "caption", "styles", "errorMessage", "childLocations", "description", "readOnly", "registeredEventListeners", "resources", "immediate", "primaryStyleName", "id", "enabled", "templateContents", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"errorMessage", "width", "registeredEventListeners", "enabled", "primaryStyleName", "modified", "resources", "required", "height", "immediate", "propertyReadOnly", "tabIndex", "readOnly", "description", "caption", "id", "styles", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"description", "registeredEventListeners", "height", "enabled", "immediate", "id", "resources", "primaryStyleName", "errorMessage", "styles", "width", "readOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"height", "styles", "readOnly", "primaryStyleName", "description", "caption", "width", "resources", "id", "registeredEventListeners", "immediate", "errorMessage", "features", "parameters", "enabled", "uriFragment", "target", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"readOnly", "caption", "id", "resources", "enabled", "height", "description", "styles", "width", "primaryStyleName", "errorMessage", "immediate", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"immediate", "caption", "resources", "width", "readOnly", "enabled", "primaryStyleName", "id", "registeredEventListeners", "description", "styles", "height", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"immediate", "enabled", "height", "resources", "caption", "id", "spacing", "width", "marginsBitmask", "description", "rows", "errorMessage", "registeredEventListeners", "childData", "primaryStyleName", "readOnly", "columns", "styles", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"htmlContentAllowed", "resources", "width", "sourceTypes", "altText", "errorMessage", "immediate", "height", "primaryStyleName", "caption", "id", "styles", "sources", "readOnly", "muted", "autoplay", "registeredEventListeners", "enabled", "showControls", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"registeredEventListeners", "hideErrors", "id", "width", "styles", "modified", "resources", "required", "height", "errorMessage", "primaryStyleName", "description", "enabled", "readOnly", "immediate", "tabIndex", "propertyReadOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"errorMessage", "resources", "width", "primaryStyleName", "caption", "registeredEventListeners", "description", "height", "styles", "enabled", "readOnly", "id", "immediate", "text", "contentMode", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"resources", "enabled", "primaryStyleName", "description", "width", "height", "registeredEventListeners", "firstChild", "splitterState", "readOnly", "styles", "id", "immediate", "caption", "secondChild", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"registeredEventListeners", "primaryStyleName", "enabled", "height", "immediate", "description", "id", "width", "caption", "styles", "errorMessage", "readOnly", "alternateText", "resources", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"errorMessage", "primaryStyleName", "required", "height", "enabled", "width", "modified", "registeredEventListeners", "resources", "tabIndex", "immediate", "styles", "propertyReadOnly", "id", "description", "caption", "readOnly", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"readOnly", "primaryStyleName", "resources", "caption", "spacing", "childData", "errorMessage", "height", "immediate", "enabled", "marginsBitmask", "id", "styles", "description", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"id", "height", "width", "modified", "footer", "layout", "errorMessage", "registeredEventListeners", "caption", "resources", "propertyReadOnly", "styles", "tabIndex", "immediate", "readOnly", "description", "primaryStyleName", "required", "enabled", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"propertyReadOnly", "modified", "hideErrors", "primaryStyleName", "styles", "tabIndex", "resources", "errorMessage", "height", "description", "id", "registeredEventListeners", "caption", "required", "enabled", "readOnly", "immediate", "width", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"ctrlKey", "relativeX", "relativeY", "clientX", "clientY", "type", "button", "metaKey", "shiftKey", "altKey", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"immediate", "enabled", "width", "height", "caption", "id", "spacing", "registeredEventListeners", "marginsBitmask", "readOnly", "resources", "childData", "description", "styles", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"width", "caption", "immediate", "height", "readOnly", "id", "styles", "primaryStyleName", "description", "enabled", "registeredEventListeners", "errorMessage", "resources", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"immediate", "tabIndex", "height", "readOnly", "id", "resources", "errorMessage", "htmlContentAllowed", "enabled", "clickShortcutKeyCode", "disableOnClick", "width", "styles", "registeredEventListeners", "description", "primaryStyleName", "caption", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"resources", "enabled", "immediate", "errorMessage", "registeredEventListeners", "height", "primaryStyleName", "styles", "htmlContentAllowed", "id", "tabIndex", "width", "disableOnClick", "readOnly", "description", "caption", "clickShortcutKeyCode", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"immediate", "resources", "width", "caption", "readOnly", "height", "styles", "primaryStyleName", "errorMessage", "id", "registeredEventListeners", "enabled", "description", "hideOnMouseOut", "html", });
            ...
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"id", "enabled", "tabIndex", "resources", "styles", "primaryStyleName", "registeredEventListeners", "errorMessage", "caption", "description", "immediate", "readOnly", "height", "width", });
            store.setProperties(com.cs.gwt.client.shared.JQChartState.class, new String[] {"resources", "id", "description", "dataClickJS", "height", "lastUpdateTime", "clickJS", "errorMessage", "immediate", "uuid", "registeredEventListeners", "readOnly", "caption", "styles", "initJS", "enabled", "refreshJS", "width", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"height", "width", "description", "id", "hideErrors", "caption", "primaryStyleName", "registeredEventListeners", "enabled", "required", "propertyReadOnly", "styles", "readOnly", "resources", "modified", "errorMessage", "immediate", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"caption", "description", "alternateText", "resources", "height", "styles", "registeredEventListeners", "readOnly", "id", "width", "immediate", "primaryStyleName", "enabled", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"resources", "immediate", "alternateText", "readOnly", "codetype", "archive", "height", "styles", "enabled", "primaryStyleName", "caption", "codebase", "description", "classId", "embedParams", "id", "registeredEventListeners", "errorMessage", "standby", "width", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"enabled", "rpcInterfaces", "registeredEventListeners", "resources", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"indeterminate", "propertyReadOnly", "enabled", "id", "immediate", "modified", "state", "tabIndex", "resources", "required", "primaryStyleName", "errorMessage", "description", "hideErrors", "height", "width", "styles", "readOnly", "caption", "registeredEventListeners", "pollingInterval", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"enabled", "primaryStyleName", "height", "styles", "readOnly", "id", "immediate", "callbackNames", "rpcInterfaces", "description", "caption", "registeredEventListeners", "errorMessage", "width", "resources", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "column2", "row2", "column1", "row1", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollTop", "description", "immediate", "height", "tabIndex", "readOnly", "enabled", "scrollLeft", "styles", "resources", "width", "registeredEventListeners", "id", "primaryStyleName", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"modified", "registeredEventListeners", "hideErrors", "propertyReadOnly", "height", "styles", "immediate", "primaryStyleName", "checked", "resources", "readOnly", "tabIndex", "enabled", "required", "caption", "id", "width", "description", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"resources", "draggable", "description", "errorMessage", "width", "resizable", "scrollTop", "tabIndex", "scrollLeft", "readOnly", "resizeLazy", "caption", "centered", "positionX", "positionY", "styles", "registeredEventListeners", "primaryStyleName", "immediate", "modal", "enabled", "height", "id", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"readOnly", "description", "height", "registeredEventListeners", "width", "styles", "id", "caption", "connectorToCssPosition", "immediate", "enabled", "resources", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"alternateText", "readOnly", "styles", "registeredEventListeners", "resources", "description", "primaryStyleName", "immediate", "width", "height", "enabled", "id", "errorMessage", "caption", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"modified", "styles", "registeredEventListeners", "errorMessage", "text", "required", "width", "readOnly", "maxLength", "inputPrompt", "enabled", "caption", "immediate", "hideErrors", "tabIndex", "propertyReadOnly", "primaryStyleName", "height", "resources", "id", "description", "columns", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"readOnly", "modified", "required", "primaryStyleName", "immediate", "resources", "styles", "enabled", "id", "propertyReadOnly", "hideErrors", "tabIndex", "height", "description", "registeredEventListeners", "caption", "width", "errorMessage", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"resources", "registeredEventListeners", "names", "enabled", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPositionUnit", "minPosition", "positionUnit", "positionReversed", "position", "maxPosition", "locked", "minPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"resources", "description", "height", "primaryStyleName", "errorMessage", "tabIndex", "required", "modified", "immediate", "caption", "registeredEventListeners", "styles", "width", "hideErrors", "propertyReadOnly", "readOnly", "id", "enabled", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"errorMessage", "styles", "readOnly", "primaryStyleName", "description", "showControls", "sourceTypes", "width", "muted", "enabled", "autoplay", "resources", "id", "registeredEventListeners", "height", "altText", "htmlContentAllowed", "caption", "sources", "immediate", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"primaryStyleName", "registeredEventListeners", "resources", "styles", "width", "childCss", "readOnly", "height", "caption", "enabled", "description", "errorMessage", "immediate", "id", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"primaryStyleName", "description", "width", "styles", "caption", "readOnly", "errorMessage", "maxLength", "columns", "tabIndex", "modified", "hideErrors", "text", "enabled", "id", "inputPrompt", "rows", "immediate", "resources", "wordwrap", "height", "registeredEventListeners", "propertyReadOnly", "required", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"registeredEventListeners", "primaryStyleName", "readOnly", "resources", "id", "secondChild", "enabled", "description", "firstChild", "height", "immediate", "splitterState", "width", "caption", "styles", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"id", "errorMessage", "cursorX", "bgColor", "cursorY", "readOnly", "width", "immediate", "enabled", "caption", "description", "primaryStyleName", "resources", "height", "registeredEventListeners", "styles", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"popupVisible", "immediate", "readOnly", "caption", "resources", "errorMessage", "id", "htmlContentAllowed", "description", "enabled", "color", "height", "styles", "primaryStyleName", "showDefaultCaption", "registeredEventListeners", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"enabled", "caption", "immediate", "description", "registeredEventListeners", "rowCount", "height", "resources", "readOnly", "columnCount", "styles", "width", "primaryStyleName", "changedColor", "id", "errorMessage", "changedX", "changedY", });
