...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.CustomField","com.vaadin.ui.UI","com.cs.jqchart.Chart","com.vaadin.ui.PasswordField","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.CheckBox","com.vaadin.ui.DateField","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.TwinColSelect","com.vaadin.ui.TextArea","com.vaadin.ui.OptionGroup","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.CustomComponent","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Table","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Flash","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Accordion","com.vaadin.ui.Embedded","com.vaadin.ui.Slider","com.vaadin.ui.Panel","com.vaadin.ui.TabSheet","com.vaadin.ui.InlineDateField","com.vaadin.ui.Window","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Audio","com.vaadin.ui.JavaScript","com.vaadin.ui.FormLayout","com.vaadin.ui.MenuBar","com.vaadin.ui.CustomLayout","com.vaadin.ui.GridLayout","com.vaadin.ui.ComboBox","com.vaadin.ui.Label","com.vaadin.ui.NativeSelect","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Link","com.vaadin.ui.NativeButton","com.vaadin.ui.Upload","com.vaadin.ui.CssLayout","com.vaadin.ui.Tree","com.vaadin.ui.Form","com.vaadin.ui.Video","com.vaadin.ui.AbsoluteLayout","com.vaadin.server.FileDownloader","com.vaadin.ui.TextField","com.vaadin.ui.PopupView","com.vaadin.ui.Button","com.vaadin.ui.Image","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.ListSelect","com.vaadin.ui.TreeTable",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"description", "width", "errorMessage", "caption", "readOnly", "immediate", "tabIndex", "id", "registeredEventListeners", "styles", "resources", "primaryStyleName", "enabled", "height", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"styles", "width", "primaryStyleName", "height", "caption", "enabled", "marginsBitmask", "spacing", "childData", "registeredEventListeners", "description", "rows", "immediate", "id", "resources", "errorMessage", "columns", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"description", "styles", "caption", "readOnly", "enabled", "width", "resources", "primaryStyleName", "callbackNames", "errorMessage", "immediate", "rpcInterfaces", "id", "registeredEventListeners", "height", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"errorMessage", "tabIndex", "registeredEventListeners", "propertyReadOnly", "styles", "id", "required", "immediate", "width", "readOnly", "enabled", "modified", "height", "caption", "description", "hideErrors", "resources", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"enabled", "modified", "readOnly", "height", "errorMessage", "immediate", "width", "caption", "resources", "hideErrors", "primaryStyleName", "propertyReadOnly", "tabIndex", "id", "indeterminate", "required", "description", "registeredEventListeners", "styles", "pollingInterval", "state", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"required", "propertyReadOnly", "description", "errorMessage", "id", "hideErrors", "registeredEventListeners", "resources", "tabIndex", "modified", "height", "immediate", "primaryStyleName", "readOnly", "caption", "footer", "width", "enabled", "styles", "layout", });
            store.setProperties(com.cs.jqchart.gwt.client.shared.JQChartState.class, new String[] {"id", "refreshJS", "readOnly", "primaryStyleName", "initJS", "width", "styles", "uuid", "resources", "height", "errorMessage", "lastUpdateTime", "immediate", "dataClickJS", "registeredEventListeners", "clickJS", "description", "caption", "enabled", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"id", "errorMessage", "styles", "height", "resources", "readOnly", "alternateText", "caption", "immediate", "registeredEventListeners", "primaryStyleName", "enabled", "width", "description", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"modified", "id", "errorMessage", "immediate", "description", "height", "required", "readOnly", "primaryStyleName", "registeredEventListeners", "width", "propertyReadOnly", "caption", "resources", "hideErrors", "enabled", "styles", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"modified", "primaryStyleName", "height", "tabIndex", "registeredEventListeners", "readOnly", "enabled", "hideErrors", "resources", "description", "required", "width", "caption", "errorMessage", "id", "textFieldEnabled", "styles", "immediate", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"enabled", "description", "errorMessage", "secondChild", "styles", "registeredEventListeners", "splitterState", "caption", "id", "firstChild", "readOnly", "immediate", "primaryStyleName", "width", "resources", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPosition", "position", "minPositionUnit", "minPosition", "positionUnit", "locked", "positionReversed", "maxPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"height", "id", "errorMessage", "resources", "description", "styles", "caption", "registeredEventListeners", "readOnly", "enabled", "immediate", "alternateText", "width", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"required", "hideErrors", "registeredEventListeners", "height", "readOnly", "errorMessage", "modified", "caption", "primaryStyleName", "width", "enabled", "description", "immediate", "id", "propertyReadOnly", "resources", "styles", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"immediate", "readOnly", "styles", "primaryStyleName", "resources", "enabled", "errorMessage", "id", "description", "registeredEventListeners", "width", "caption", "marginsBitmask", "childData", "spacing", "height", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "registeredEventListeners", "enabled", "callbackNames", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"showControls", "styles", "autoplay", "sources", "id", "registeredEventListeners", "resources", "muted", "height", "readOnly", "width", "description", "htmlContentAllowed", "caption", "enabled", "immediate", "altText", "errorMessage", "primaryStyleName", "sourceTypes", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"registeredEventListeners", "height", "immediate", "readOnly", "primaryStyleName", "errorMessage", "enabled", "styles", "width", "id", "description", "resources", "caption", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"tabIndex", "caption", "propertyReadOnly", "modified", "registeredEventListeners", "errorMessage", "height", "readOnly", "resources", "width", "primaryStyleName", "hideErrors", "description", "immediate", "styles", "enabled", "required", "id", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"enabled", "width", "caption", "registeredEventListeners", "description", "immediate", "styles", "id", "readOnly", "primaryStyleName", "height", "errorMessage", "resources", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"contentMode", "styles", "height", "caption", "id", "primaryStyleName", "text", "immediate", "description", "errorMessage", "registeredEventListeners", "width", "readOnly", "resources", "enabled", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"id", "required", "registeredEventListeners", "enabled", "columns", "modified", "tabIndex", "errorMessage", "height", "text", "width", "styles", "immediate", "inputPrompt", "primaryStyleName", "maxLength", "resources", "caption", "wordwrap", "propertyReadOnly", "description", "hideErrors", "rows", "readOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"id", "required", "resources", "tabIndex", "immediate", "description", "width", "modified", "primaryStyleName", "hideErrors", "height", "propertyReadOnly", "readOnly", "caption", "styles", "errorMessage", "enabled", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"htmlContentAllowed", "immediate", "description", "id", "clickShortcutKeyCode", "registeredEventListeners", "caption", "disableOnClick", "height", "errorMessage", "width", "styles", "resources", "primaryStyleName", "enabled", "readOnly", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"templateContents", "description", "width", "immediate", "resources", "styles", "registeredEventListeners", "readOnly", "errorMessage", "childLocations", "caption", "templateName", "primaryStyleName", "id", "enabled", "height", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"hideOnMouseOut", "immediate", "readOnly", "enabled", "width", "resources", "html", "caption", "errorMessage", "description", "registeredEventListeners", "id", "height", "styles", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"height", "primaryStyleName", "registeredEventListeners", "enabled", "hideErrors", "width", "readOnly", "description", "errorMessage", "modified", "styles", "resources", "caption", "propertyReadOnly", "tabIndex", "id", "required", "immediate", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"id", "caption", "primaryStyleName", "connectorToCssPosition", "enabled", "description", "errorMessage", "width", "resources", "height", "readOnly", "registeredEventListeners", "styles", "immediate", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"registeredEventListeners", "tabIndex", "id", "scrollTop", "caption", "readOnly", "styles", "errorMessage", "primaryStyleName", "width", "immediate", "resources", "description", "enabled", "scrollLeft", "height", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"readOnly", "primaryStyleName", "registeredEventListeners", "immediate", "caption", "width", "id", "description", "height", "resources", "styles", "childData", "spacing", "errorMessage", "enabled", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"caption", "styles", "resources", "description", "inputPrompt", "width", "height", "errorMessage", "primaryStyleName", "required", "maxLength", "id", "text", "modified", "propertyReadOnly", "hideErrors", "registeredEventListeners", "tabIndex", "readOnly", "enabled", "immediate", "columns", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"childCss", "readOnly", "resources", "styles", "registeredEventListeners", "enabled", "height", "immediate", "errorMessage", "width", "caption", "id", "primaryStyleName", "description", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"styles", "errorMessage", "width", "primaryStyleName", "registeredEventListeners", "description", "resources", "id", "splitterState", "immediate", "height", "enabled", "firstChild", "caption", "readOnly", "secondChild", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"registeredEventListeners", "readOnly", "marginsBitmask", "immediate", "spacing", "childData", "resources", "height", "errorMessage", "caption", "width", "description", "enabled", "styles", "primaryStyleName", "id", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"primaryStyleName", "immediate", "registeredEventListeners", "hideErrors", "errorMessage", "required", "resources", "modified", "id", "caption", "enabled", "height", "checked", "readOnly", "tabIndex", "width", "styles", "description", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"height", "sources", "primaryStyleName", "styles", "registeredEventListeners", "errorMessage", "id", "muted", "resources", "sourceTypes", "showControls", "enabled", "altText", "caption", "width", "description", "htmlContentAllowed", "immediate", "autoplay", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"errorMessage", "primaryStyleName", "caption", "enabled", "readOnly", "immediate", "description", "styles", "registeredEventListeners", "width", "resources", "height", "id", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"height", "width", "errorMessage", "resources", "immediate", "id", "readOnly", "registeredEventListeners", "styles", "description", "caption", "enabled", "primaryStyleName", "alternateText", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"registeredEventListeners", "uriFragment", "target", "parameters", "styles", "id", "errorMessage", "readOnly", "primaryStyleName", "resources", "immediate", "description", "height", "enabled", "width", "caption", "features", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"tabIndex", "width", "id", "enabled", "registeredEventListeners", "styles", "height", "propertyReadOnly", "readOnly", "description", "errorMessage", "primaryStyleName", "caption", "hideErrors", "resources", "modified", "immediate", "required", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"required", "enabled", "id", "hideErrors", "modified", "height", "description", "caption", "styles", "width", "immediate", "tabIndex", "errorMessage", "resources", "primaryStyleName", "registeredEventListeners", "propertyReadOnly", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"resizable", "centered", "primaryStyleName", "caption", "draggable", "registeredEventListeners", "immediate", "resizeLazy", "readOnly", "description", "resources", "height", "positionX", "tabIndex", "enabled", "positionY", "id", "scrollLeft", "scrollTop", "errorMessage", "width", "styles", "modal", });
            ...
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"immediate", "styles", "caption", "primaryStyleName", "description", "resources", "enabled", "readOnly", "errorMessage", "width", "id", "height", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"errorMessage", "registeredEventListeners", "classId", "id", "readOnly", "embedParams", "archive", "standby", "codetype", "height", "immediate", "styles", "caption", "codebase", "description", "resources", "enabled", "alternateText", "primaryStyleName", "width", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"readOnly", "htmlContentAllowed", "caption", "id", "enabled", "height", "errorMessage", "tabIndex", "primaryStyleName", "registeredEventListeners", "width", "immediate", "disableOnClick", "clickShortcutKeyCode", "styles", "description", "resources", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"hideErrors", "registeredEventListeners", "description", "errorMessage", "resources", "immediate", "modified", "styles", "height", "minValue", "id", "caption", "orientation", "propertyReadOnly", "value", "tabIndex", "primaryStyleName", "enabled", "maxValue", "required", "readOnly", "resolution", "width", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"shiftKey", "clientX", "ctrlKey", "clientY", "relativeX", "relativeY", "type", "metaKey", "button", "altKey", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"errorMessage", "primaryStyleName", "readOnly", "description", "cursorX", "cursorY", "resources", "styles", "id", "immediate", "bgColor", "registeredEventListeners", "height", "width", "enabled", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"width", "caption", "resources", "readOnly", "primaryStyleName", "htmlContentAllowed", "popupVisible", "description", "styles", "immediate", "errorMessage", "color", "showDefaultCaption", "height", "id", "registeredEventListeners", "enabled", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"rowCount", "columnCount", "caption", "id", "width", "primaryStyleName", "changedX", "changedY", "changedColor", "immediate", "enabled", "registeredEventListeners", "errorMessage", "resources", "description", "height", "readOnly", "styles", });
