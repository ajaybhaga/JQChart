...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Image","com.vaadin.ui.InlineDateField","com.vaadin.ui.TabSheet","com.vaadin.ui.ListSelect","com.vaadin.ui.Label","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Flash","com.vaadin.ui.PopupView","com.vaadin.ui.Panel","com.vaadin.ui.TreeTable","com.vaadin.ui.OptionGroup","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.TextArea","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Embedded","com.vaadin.ui.CustomComponent","com.vaadin.ui.NativeButton","com.vaadin.ui.Table","com.vaadin.ui.Button","com.vaadin.ui.DateField","com.vaadin.ui.UI","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Form","com.vaadin.ui.Slider","com.vaadin.ui.CustomField","com.vaadin.ui.Upload","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Link","com.vaadin.ui.Tree","com.vaadin.ui.Window","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.CustomLayout","com.vaadin.ui.JavaScript","com.vaadin.ui.ComboBox","com.vaadin.server.FileDownloader","com.vaadin.ui.PasswordField","com.vaadin.ui.Audio","com.vaadin.ui.CssLayout","com.vaadin.ui.Video","com.vaadin.ui.TextField","com.vaadin.ui.GridLayout","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.CheckBox","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.BrowserFrame","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.Accordion","com.vaadin.ui.MenuBar","com.vaadin.ui.VerticalLayout","com.vaadin.ui.NativeSelect","com.vaadin.ui.FormLayout",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"resources", "enabled", "styles", "height", "errorMessage", "immediate", "registeredEventListeners", "alternateText", "readOnly", "caption", "width", "id", "primaryStyleName", "description", });
            ...
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"height", "enabled", "hideErrors", "id", "description", "width", "immediate", "primaryStyleName", "readOnly", "tabIndex", "registeredEventListeners", "errorMessage", "modified", "caption", "styles", "propertyReadOnly", "required", "resources", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"required", "registeredEventListeners", "height", "description", "propertyReadOnly", "primaryStyleName", "errorMessage", "inputPrompt", "immediate", "readOnly", "width", "modified", "enabled", "resources", "maxLength", "tabIndex", "id", "text", "hideErrors", "columns", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"resources", "disableOnClick", "htmlContentAllowed", "tabIndex", "styles", "height", "description", "id", "enabled", "caption", "errorMessage", "immediate", "width", "clickShortcutKeyCode", "primaryStyleName", "registeredEventListeners", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"styles", "enabled", "primaryStyleName", "id", "caption", "readOnly", "immediate", "required", "tabIndex", "description", "modified", "width", "hideErrors", "height", "propertyReadOnly", "registeredEventListeners", "resources", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"resources", "description", "enabled", "height", "styles", "readOnly", "errorMessage", "width", "primaryStyleName", "rpcInterfaces", "callbackNames", "caption", "immediate", "registeredEventListeners", "id", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"registeredEventListeners", "id", "width", "footer", "caption", "errorMessage", "hideErrors", "tabIndex", "height", "resources", "primaryStyleName", "immediate", "styles", "propertyReadOnly", "description", "readOnly", "modified", "layout", "required", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"immediate", "propertyReadOnly", "hideErrors", "errorMessage", "modified", "enabled", "height", "caption", "required", "value", "styles", "registeredEventListeners", "id", "width", "resolution", "description", "maxValue", "tabIndex", "primaryStyleName", "minValue", "resources", "orientation", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"classId", "standby", "alternateText", "enabled", "id", "codebase", "caption", "height", "archive", "description", "resources", "registeredEventListeners", "immediate", "styles", "errorMessage", "readOnly", "primaryStyleName", "embedParams", "width", "codetype", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"immediate", "id", "styles", "readOnly", "propertyReadOnly", "errorMessage", "required", "primaryStyleName", "description", "registeredEventListeners", "tabIndex", "hideErrors", "width", "enabled", "caption", "modified", "resources", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"width", "immediate", "resources", "registeredEventListeners", "enabled", "secondChild", "height", "id", "styles", "splitterState", "caption", "errorMessage", "readOnly", "description", "firstChild", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"description", "height", "childData", "styles", "width", "caption", "rows", "resources", "columns", "id", "spacing", "readOnly", "immediate", "errorMessage", "enabled", "registeredEventListeners", "primaryStyleName", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"description", "primaryStyleName", "caption", "width", "readOnly", "styles", "spacing", "height", "childData", "id", "marginsBitmask", "errorMessage", "enabled", "resources", "registeredEventListeners", "immediate", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"readOnly", "width", "htmlContentAllowed", "registeredEventListeners", "enabled", "clickShortcutKeyCode", "id", "immediate", "errorMessage", "styles", "caption", "disableOnClick", "height", "tabIndex", "resources", "description", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"pollingInterval", "propertyReadOnly", "immediate", "primaryStyleName", "width", "indeterminate", "registeredEventListeners", "id", "state", "tabIndex", "description", "readOnly", "resources", "caption", "required", "errorMessage", "styles", "modified", "enabled", "hideErrors", "height", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"description", "resources", "immediate", "hideErrors", "height", "caption", "readOnly", "propertyReadOnly", "required", "errorMessage", "id", "tabIndex", "enabled", "registeredEventListeners", "primaryStyleName", "width", "modified", "styles", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"errorMessage", "enabled", "connectorToCssPosition", "immediate", "registeredEventListeners", "caption", "id", "readOnly", "resources", "description", "width", "styles", "height", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"names", "registeredEventListeners", "resources", "enabled", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"registeredEventListeners", "immediate", "enabled", "primaryStyleName", "resources", "text", "contentMode", "height", "width", "styles", "errorMessage", "readOnly", "caption", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"target", "readOnly", "styles", "uriFragment", "parameters", "description", "errorMessage", "id", "width", "resources", "primaryStyleName", "height", "immediate", "enabled", "caption", "registeredEventListeners", "features", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"column2", "alignment", "column1", "row2", "row1", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"modified", "id", "resources", "hideErrors", "required", "readOnly", "width", "tabIndex", "height", "propertyReadOnly", "primaryStyleName", "enabled", "description", "styles", "immediate", "errorMessage", "registeredEventListeners", "caption", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"styles", "scrollLeft", "width", "errorMessage", "positionY", "description", "caption", "positionX", "immediate", "enabled", "id", "scrollTop", "resources", "centered", "tabIndex", "registeredEventListeners", "resizable", "modal", "primaryStyleName", "readOnly", "height", "resizeLazy", "draggable", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"caption", "height", "id", "resources", "hideErrors", "width", "tabIndex", "primaryStyleName", "modified", "enabled", "registeredEventListeners", "description", "propertyReadOnly", "required", "readOnly", "errorMessage", "styles", "immediate", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"childData", "width", "enabled", "caption", "height", "description", "readOnly", "primaryStyleName", "id", "errorMessage", "spacing", "styles", "marginsBitmask", "immediate", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"registeredEventListeners", "modified", "required", "hideErrors", "caption", "styles", "id", "immediate", "enabled", "tabIndex", "errorMessage", "width", "resources", "readOnly", "description", "primaryStyleName", "checked", "propertyReadOnly", "height", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"immediate", "id", "styles", "width", "resources", "caption", "errorMessage", "description", "enabled", "registeredEventListeners", "primaryStyleName", "childCss", "height", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"immediate", "alternateText", "caption", "registeredEventListeners", "resources", "id", "height", "readOnly", "styles", "enabled", "width", "description", "errorMessage", "primaryStyleName", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"button", "shiftKey", "clientY", "clientX", "relativeY", "ctrlKey", "relativeX", "altKey", "type", "metaKey", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"registeredEventListeners", "scrollTop", "enabled", "resources", "immediate", "styles", "width", "description", "readOnly", "scrollLeft", "primaryStyleName", "height", "errorMessage", "tabIndex", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"styles", "description", "height", "caption", "primaryStyleName", "immediate", "readOnly", "html", "id", "enabled", "errorMessage", "width", "hideOnMouseOut", "resources", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"height", "readOnly", "caption", "description", "styles", "resources", "id", "errorMessage", "primaryStyleName", "registeredEventListeners", "width", "enabled", "immediate", });
            ...
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"errorMessage", "width", "registeredEventListeners", "styles", "id", "height", "caption", "description", "resources", "immediate", "readOnly", "tabIndex", "primaryStyleName", "enabled", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"styles", "caption", "height", "resources", "description", "immediate", "errorMessage", "enabled", "id", "registeredEventListeners", "readOnly", "primaryStyleName", "width", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"immediate", "caption", "width", "height", "description", "alternateText", "enabled", "readOnly", "registeredEventListeners", "resources", "id", "styles", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"required", "styles", "readOnly", "id", "width", "resources", "errorMessage", "wordwrap", "caption", "rows", "propertyReadOnly", "tabIndex", "registeredEventListeners", "hideErrors", "text", "primaryStyleName", "immediate", "columns", "inputPrompt", "height", "modified", "enabled", "maxLength", "description", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"description", "height", "resources", "enabled", "errorMessage", "primaryStyleName", "styles", "readOnly", "caption", "width", "registeredEventListeners", "immediate", "id", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"height", "caption", "registeredEventListeners", "splitterState", "readOnly", "primaryStyleName", "description", "styles", "resources", "firstChild", "immediate", "secondChild", "id", "errorMessage", "enabled", "width", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"height", "description", "enabled", "readOnly", "resources", "immediate", "errorMessage", "caption", "width", "id", "registeredEventListeners", "primaryStyleName", "styles", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"readOnly", "registeredEventListeners", "id", "caption", "sourceTypes", "primaryStyleName", "muted", "description", "width", "errorMessage", "height", "immediate", "showControls", "autoplay", "altText", "sources", "styles", "enabled", "resources", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"id", "tabIndex", "immediate", "height", "readOnly", "required", "primaryStyleName", "hideErrors", "registeredEventListeners", "modified", "styles", "description", "errorMessage", "width", "propertyReadOnly", "enabled", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"description", "width", "styles", "height", "marginsBitmask", "immediate", "id", "errorMessage", "caption", "childData", "registeredEventListeners", "readOnly", "resources", "enabled", "spacing", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"caption", "showControls", "altText", "sourceTypes", "primaryStyleName", "immediate", "readOnly", "width", "autoplay", "height", "errorMessage", "styles", "id", "htmlContentAllowed", "enabled", "sources", "registeredEventListeners", "resources", "muted", "description", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPositionUnit", "maxPosition", "minPositionUnit", "locked", "minPosition", "position", "positionUnit", "positionReversed", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"description", "templateContents", "registeredEventListeners", "primaryStyleName", "resources", "childLocations", "readOnly", "height", "styles", "enabled", "caption", "errorMessage", "id", "immediate", "width", "templateName", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"modified", "tabIndex", "hideErrors", "description", "enabled", "immediate", "id", "width", "height", "readOnly", "caption", "registeredEventListeners", "textFieldEnabled", "styles", "propertyReadOnly", "resources", "primaryStyleName", "required", "errorMessage", });
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"primaryStyleName", "height", "width", "readOnly", "caption", "enabled", "propertyReadOnly", "errorMessage", "required", "immediate", "styles", "resources", "registeredEventListeners", "modified", "tabIndex", "id", "hideErrors", "description", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"bgColor", "cursorY", "caption", "styles", "id", "errorMessage", "registeredEventListeners", "description", "width", "enabled", "height", "readOnly", "immediate", "cursorX", "resources", "primaryStyleName", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"id", "styles", "enabled", "color", "popupVisible", "width", "htmlContentAllowed", "primaryStyleName", "caption", "resources", "readOnly", "errorMessage", "height", "registeredEventListeners", "immediate", "description", "showDefaultCaption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"primaryStyleName", "width", "errorMessage", "id", "height", "description", "caption", "columnCount", "resources", "changedColor", "changedX", "registeredEventListeners", "readOnly", "changedY", "styles", "enabled", "rowCount", "immediate", });
