...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Image","com.vaadin.ui.UI","com.vaadin.ui.PasswordField","com.vaadin.ui.GridLayout","com.vaadin.ui.MenuBar","com.vaadin.ui.Audio","com.vaadin.ui.CheckBox","com.vaadin.ui.Window","com.vaadin.ui.TabSheet","com.vaadin.ui.Tree","com.vaadin.ui.CustomComponent","com.vaadin.ui.FormLayout","com.vaadin.ui.Panel","com.vaadin.ui.Accordion","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Button","com.vaadin.ui.CustomLayout","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.BrowserFrame","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.DateField","com.vaadin.ui.InlineDateField","com.vaadin.ui.TreeTable","com.vaadin.ui.CustomField","com.vaadin.ui.Upload","com.vaadin.ui.Video","com.vaadin.ui.Flash","com.vaadin.ui.TextArea","com.vaadin.ui.Table","com.vaadin.ui.TwinColSelect","com.vaadin.server.FileDownloader","com.vaadin.ui.TextField","com.vaadin.ui.Label","com.vaadin.ui.JavaScript","com.vaadin.ui.NativeSelect","com.vaadin.ui.NativeButton","com.vaadin.ui.PopupView","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.ListSelect","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Link","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Form","com.cs.Chart","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.ComboBox","com.vaadin.ui.OptionGroup","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.CssLayout","com.vaadin.ui.Embedded","com.vaadin.ui.Slider",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "enabled", "rpcInterfaces", "resources", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"enabled", "errorMessage", "tabIndex", "rows", "text", "id", "modified", "caption", "height", "width", "resources", "wordwrap", "columns", "inputPrompt", "primaryStyleName", "registeredEventListeners", "propertyReadOnly", "readOnly", "styles", "immediate", "maxLength", "description", "required", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"height", "enabled", "readOnly", "immediate", "errorMessage", "primaryStyleName", "resources", "hideErrors", "required", "registeredEventListeners", "caption", "id", "description", "styles", "tabIndex", "width", "propertyReadOnly", "modified", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"registeredEventListeners", "width", "enabled", "errorMessage", "resources", "immediate", "height", "primaryStyleName", "id", "connectorToCssPosition", "styles", "readOnly", "caption", "description", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"hideErrors", "readOnly", "resources", "required", "primaryStyleName", "immediate", "registeredEventListeners", "width", "tabIndex", "enabled", "modified", "id", "caption", "propertyReadOnly", "description", "height", "errorMessage", "footer", "styles", "layout", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"immediate", "id", "height", "enabled", "styles", "modified", "primaryStyleName", "tabIndex", "readOnly", "hideErrors", "width", "errorMessage", "caption", "description", "registeredEventListeners", "required", "resources", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"enabled", "columns", "styles", "marginsBitmask", "errorMessage", "description", "id", "spacing", "childData", "height", "readOnly", "registeredEventListeners", "immediate", "caption", "resources", "primaryStyleName", "width", "rows", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"enabled", "resources", "errorMessage", "registeredEventListeners", "styles", "caption", "target", "immediate", "width", "id", "primaryStyleName", "description", "parameters", "features", "readOnly", "uriFragment", "height", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"readOnly", "codebase", "codetype", "id", "styles", "embedParams", "errorMessage", "caption", "standby", "immediate", "description", "classId", "alternateText", "archive", "height", "enabled", "resources", "primaryStyleName", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"enabled", "styles", "errorMessage", "caption", "height", "description", "readOnly", "primaryStyleName", "immediate", "resources", "width", "id", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"resources", "hideOnMouseOut", "immediate", "styles", "caption", "id", "enabled", "errorMessage", "description", "registeredEventListeners", "height", "primaryStyleName", "width", "html", "readOnly", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"altText", "description", "primaryStyleName", "height", "readOnly", "caption", "styles", "htmlContentAllowed", "enabled", "sources", "errorMessage", "sourceTypes", "width", "id", "resources", "muted", "immediate", "autoplay", "registeredEventListeners", "showControls", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"primaryStyleName", "registeredEventListeners", "enabled", "htmlContentAllowed", "caption", "height", "description", "errorMessage", "immediate", "styles", "tabIndex", "disableOnClick", "width", "clickShortcutKeyCode", "resources", "id", "readOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"errorMessage", "required", "hideErrors", "enabled", "tabIndex", "caption", "propertyReadOnly", "resources", "immediate", "modified", "id", "primaryStyleName", "width", "description", "readOnly", "registeredEventListeners", "height", "styles", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"description", "id", "errorMessage", "primaryStyleName", "styles", "height", "enabled", "caption", "registeredEventListeners", "readOnly", "immediate", "width", "resources", "alternateText", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"caption", "registeredEventListeners", "resources", "height", "styles", "errorMessage", "readOnly", "id", "enabled", "width", "primaryStyleName", "description", "immediate", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"readOnly", "errorMessage", "enabled", "resources", "primaryStyleName", "tabIndex", "description", "hideErrors", "modified", "height", "required", "id", "propertyReadOnly", "caption", "immediate", "width", "registeredEventListeners", "styles", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"registeredEventListeners", "height", "immediate", "resources", "readOnly", "styles", "description", "enabled", "errorMessage", "caption", "primaryStyleName", "width", "id", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"names", "enabled", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"readOnly", "propertyReadOnly", "modified", "errorMessage", "id", "registeredEventListeners", "enabled", "tabIndex", "pollingInterval", "resources", "description", "styles", "hideErrors", "width", "caption", "primaryStyleName", "indeterminate", "required", "immediate", "state", "height", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"modified", "readOnly", "enabled", "styles", "hideErrors", "immediate", "tabIndex", "propertyReadOnly", "description", "caption", "height", "width", "resources", "id", "registeredEventListeners", "errorMessage", "primaryStyleName", "required", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"styles", "immediate", "description", "primaryStyleName", "errorMessage", "readOnly", "caption", "resources", "width", "registeredEventListeners", "alternateText", "height", "id", "enabled", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"height", "width", "primaryStyleName", "readOnly", "styles", "errorMessage", "resources", "enabled", "description", "templateContents", "childLocations", "templateName", "registeredEventListeners", "immediate", "caption", "id", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"height", "width", "errorMessage", "readOnly", "modified", "propertyReadOnly", "required", "description", "enabled", "tabIndex", "immediate", "styles", "primaryStyleName", "hideErrors", "registeredEventListeners", "resources", "caption", "textFieldEnabled", "id", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"description", "alternateText", "caption", "styles", "errorMessage", "height", "immediate", "resources", "readOnly", "enabled", "id", "primaryStyleName", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"secondChild", "primaryStyleName", "description", "width", "readOnly", "caption", "id", "resources", "enabled", "firstChild", "immediate", "registeredEventListeners", "splitterState", "styles", "errorMessage", "height", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"modified", "description", "registeredEventListeners", "hideErrors", "primaryStyleName", "resources", "enabled", "width", "required", "styles", "tabIndex", "readOnly", "immediate", "id", "errorMessage", "propertyReadOnly", "caption", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "maxPosition", "position", "locked", "positionUnit", "maxPositionUnit", "minPositionUnit", "minPosition", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"childData", "primaryStyleName", "height", "description", "immediate", "marginsBitmask", "styles", "caption", "id", "registeredEventListeners", "spacing", "errorMessage", "resources", "readOnly", "width", "enabled", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"height", "registeredEventListeners", "propertyReadOnly", "modified", "hideErrors", "required", "readOnly", "description", "errorMessage", "width", "enabled", "id", "caption", "tabIndex", "resources", "checked", "immediate", "primaryStyleName", "styles", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"styles", "resources", "id", "description", "height", "caption", "registeredEventListeners", "readOnly", "immediate", "enabled", "errorMessage", "tabIndex", "width", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"height", "spacing", "primaryStyleName", "childData", "immediate", "errorMessage", "styles", "id", "registeredEventListeners", "description", "readOnly", "caption", "enabled", "width", "resources", "marginsBitmask", });
            ...
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"description", "showControls", "caption", "enabled", "immediate", "htmlContentAllowed", "width", "id", "muted", "sources", "registeredEventListeners", "styles", "sourceTypes", "errorMessage", "altText", "readOnly", "resources", "autoplay", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"styles", "width", "resources", "registeredEventListeners", "caption", "enabled", "description", "primaryStyleName", "id", "errorMessage", "tabIndex", "readOnly", "scrollLeft", "scrollTop", "height", "immediate", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeY", "ctrlKey", "relativeX", "button", "shiftKey", "clientY", "type", "altKey", "clientX", "metaKey", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"column1", "alignment", "column2", "row2", "row1", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"registeredEventListeners", "rpcInterfaces", "resources", "description", "caption", "width", "height", "enabled", "errorMessage", "id", "styles", "primaryStyleName", "readOnly", "immediate", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"errorMessage", "enabled", "spacing", "id", "immediate", "height", "caption", "childData", "readOnly", "description", "resources", "styles", "primaryStyleName", "width", "registeredEventListeners", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"propertyReadOnly", "styles", "immediate", "width", "readOnly", "id", "required", "height", "hideErrors", "tabIndex", "enabled", "primaryStyleName", "description", "registeredEventListeners", "caption", "modified", "resources", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"resources", "readOnly", "errorMessage", "primaryStyleName", "description", "caption", "firstChild", "secondChild", "id", "height", "width", "styles", "immediate", "registeredEventListeners", "splitterState", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"resources", "id", "enabled", "primaryStyleName", "value", "registeredEventListeners", "hideErrors", "height", "width", "propertyReadOnly", "required", "styles", "tabIndex", "readOnly", "errorMessage", "modified", "resolution", "maxValue", "description", "orientation", "immediate", "minValue", "caption", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"height", "id", "positionY", "readOnly", "positionX", "scrollTop", "primaryStyleName", "scrollLeft", "centered", "styles", "registeredEventListeners", "description", "tabIndex", "resizeLazy", "resizable", "immediate", "width", "draggable", "errorMessage", "modal", "enabled", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"errorMessage", "height", "registeredEventListeners", "propertyReadOnly", "caption", "enabled", "styles", "resources", "readOnly", "hideErrors", "tabIndex", "width", "required", "immediate", "description", "id", "modified", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"maxLength", "primaryStyleName", "columns", "hideErrors", "required", "styles", "errorMessage", "text", "modified", "enabled", "id", "propertyReadOnly", "immediate", "registeredEventListeners", "inputPrompt", "height", "resources", "caption", "tabIndex", "width", "description", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"width", "caption", "description", "id", "resources", "primaryStyleName", "registeredEventListeners", "childCss", "height", "readOnly", "immediate", "errorMessage", "enabled", "styles", });
            store.setProperties(com.cs.gwt.client.shared.JQChartState.class, new String[] {"resources", "refreshJS", "caption", "uuid", "lastUpdateTime", "id", "description", "height", "width", "errorMessage", "registeredEventListeners", "styles", "enabled", "clickJS", "dataClickJS", "primaryStyleName", "readOnly", "initJS", "immediate", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"caption", "primaryStyleName", "registeredEventListeners", "immediate", "resources", "description", "height", "errorMessage", "enabled", "styles", "width", "readOnly", "id", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"errorMessage", "id", "caption", "enabled", "readOnly", "clickShortcutKeyCode", "resources", "htmlContentAllowed", "registeredEventListeners", "disableOnClick", "tabIndex", "styles", "primaryStyleName", "width", "immediate", "description", "height", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"resources", "description", "caption", "errorMessage", "text", "height", "registeredEventListeners", "styles", "primaryStyleName", "enabled", "contentMode", "width", "readOnly", "immediate", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"id", "description", "bgColor", "caption", "registeredEventListeners", "immediate", "cursorY", "height", "enabled", "styles", "cursorX", "width", "primaryStyleName", "errorMessage", "resources", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"primaryStyleName", "resources", "enabled", "immediate", "readOnly", "width", "description", "id", "registeredEventListeners", "showDefaultCaption", "caption", "popupVisible", "height", "color", "styles", "htmlContentAllowed", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"changedX", "changedY", "caption", "id", "description", "columnCount", "changedColor", "height", "registeredEventListeners", "immediate", "rowCount", "enabled", "errorMessage", "resources", "styles", "primaryStyleName", "readOnly", "width", });
