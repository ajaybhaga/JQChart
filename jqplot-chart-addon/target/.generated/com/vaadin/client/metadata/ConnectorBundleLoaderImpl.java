...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Embedded","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.UI","com.vaadin.ui.CustomField","com.vaadin.ui.Link","com.vaadin.ui.Tree","com.vaadin.ui.TreeTable","com.vaadin.ui.TwinColSelect","com.vaadin.ui.BrowserFrame","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.NativeSelect","com.vaadin.ui.Window","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Accordion","com.vaadin.ui.Video","com.vaadin.ui.Upload","com.vaadin.ui.ComboBox","com.vaadin.ui.CustomLayout","com.vaadin.ui.Image","com.vaadin.ui.TextField","com.cs.jqchart.Chart","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Label","com.vaadin.ui.Panel","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.Form","com.vaadin.ui.Audio","com.vaadin.ui.CssLayout","com.vaadin.ui.NativeButton","com.vaadin.ui.GridLayout","com.vaadin.ui.Table","com.vaadin.ui.PasswordField","com.vaadin.ui.Button","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.VerticalLayout","com.vaadin.ui.CheckBox","com.vaadin.ui.OptionGroup","com.vaadin.ui.Flash","com.vaadin.ui.VerticalSplitPanel","com.vaadin.server.FileDownloader","com.vaadin.ui.Slider","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.MenuBar","com.vaadin.ui.PopupView","com.vaadin.ui.InlineDateField","com.vaadin.ui.JavaScript","com.vaadin.ui.TabSheet","com.vaadin.ui.DateField","com.vaadin.ui.CustomComponent","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.FormLayout","com.vaadin.ui.TextArea","com.vaadin.ui.ListSelect",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"readOnly", "spacing", "enabled", "width", "primaryStyleName", "marginsBitmask", "description", "styles", "id", "height", "childData", "registeredEventListeners", "errorMessage", "caption", "immediate", "resources", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"styles", "standby", "alternateText", "classId", "resources", "errorMessage", "codetype", "height", "enabled", "embedParams", "registeredEventListeners", "id", "width", "readOnly", "caption", "description", "codebase", "archive", "immediate", "primaryStyleName", });
            store.setProperties(com.cs.jqchart.gwt.client.shared.JQChartState.class, new String[] {"initJS", "readOnly", "clickJS", "styles", "dataClickJS", "width", "description", "lastUpdateTime", "enabled", "errorMessage", "refreshJS", "caption", "primaryStyleName", "uuid", "id", "registeredEventListeners", "height", "resources", "immediate", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"caption", "modal", "draggable", "resources", "width", "resizeLazy", "description", "centered", "height", "id", "scrollLeft", "immediate", "primaryStyleName", "scrollTop", "readOnly", "enabled", "styles", "errorMessage", "resizable", "registeredEventListeners", "tabIndex", "positionX", "positionY", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"immediate", "primaryStyleName", "height", "registeredEventListeners", "width", "caption", "description", "id", "errorMessage", "resources", "enabled", "styles", "childCss", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"immediate", "id", "textFieldEnabled", "resources", "height", "errorMessage", "hideErrors", "styles", "description", "readOnly", "primaryStyleName", "width", "required", "tabIndex", "propertyReadOnly", "registeredEventListeners", "caption", "modified", "enabled", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"readOnly", "styles", "height", "spacing", "description", "registeredEventListeners", "width", "id", "childData", "rows", "primaryStyleName", "immediate", "resources", "marginsBitmask", "caption", "enabled", "columns", "errorMessage", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"tabIndex", "readOnly", "resources", "required", "styles", "id", "hideErrors", "errorMessage", "immediate", "height", "width", "propertyReadOnly", "modified", "primaryStyleName", "registeredEventListeners", "description", "caption", "enabled", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"id", "width", "enabled", "errorMessage", "resources", "immediate", "readOnly", "description", "alternateText", "caption", "registeredEventListeners", "height", "styles", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"styles", "secondChild", "width", "description", "errorMessage", "immediate", "id", "readOnly", "enabled", "resources", "primaryStyleName", "caption", "registeredEventListeners", "height", "firstChild", "splitterState", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"modified", "description", "immediate", "tabIndex", "resources", "primaryStyleName", "styles", "propertyReadOnly", "registeredEventListeners", "enabled", "height", "caption", "errorMessage", "width", "required", "hideErrors", "id", "readOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"resources", "height", "id", "hideErrors", "registeredEventListeners", "checked", "propertyReadOnly", "primaryStyleName", "enabled", "readOnly", "errorMessage", "required", "styles", "modified", "immediate", "description", "tabIndex", "width", "caption", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"primaryStyleName", "rpcInterfaces", "registeredEventListeners", "readOnly", "callbackNames", "immediate", "resources", "height", "width", "enabled", "errorMessage", "caption", "styles", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"height", "enabled", "required", "propertyReadOnly", "registeredEventListeners", "immediate", "description", "resources", "caption", "width", "modified", "errorMessage", "hideErrors", "readOnly", "styles", "primaryStyleName", "id", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"spacing", "width", "id", "description", "readOnly", "resources", "errorMessage", "enabled", "immediate", "marginsBitmask", "height", "registeredEventListeners", "styles", "primaryStyleName", "caption", "childData", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"enabled", "resources", "styles", "id", "immediate", "propertyReadOnly", "registeredEventListeners", "primaryStyleName", "tabIndex", "width", "description", "readOnly", "caption", "required", "height", "hideErrors", "modified", "errorMessage", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"clientY", "metaKey", "ctrlKey", "clientX", "button", "shiftKey", "type", "relativeX", "altKey", "relativeY", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"description", "enabled", "errorMessage", "html", "styles", "hideOnMouseOut", "readOnly", "immediate", "height", "width", "primaryStyleName", "resources", "id", "caption", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"primaryStyleName", "marginsBitmask", "description", "errorMessage", "height", "enabled", "spacing", "childData", "width", "readOnly", "caption", "id", "registeredEventListeners", "resources", "immediate", "styles", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"styles", "resources", "height", "immediate", "description", "id", "width", "registeredEventListeners", "errorMessage", "readOnly", "primaryStyleName", "enabled", "caption", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "width", "readOnly", "clickShortcutKeyCode", "tabIndex", "description", "registeredEventListeners", "styles", "htmlContentAllowed", "enabled", "disableOnClick", "height", "resources", "immediate", "errorMessage", "caption", "id", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"id", "height", "required", "readOnly", "caption", "resources", "registeredEventListeners", "description", "immediate", "width", "propertyReadOnly", "enabled", "errorMessage", "hideErrors", "styles", "modified", "primaryStyleName", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"styles", "readOnly", "id", "sources", "autoplay", "htmlContentAllowed", "enabled", "width", "errorMessage", "primaryStyleName", "muted", "immediate", "registeredEventListeners", "description", "altText", "showControls", "height", "resources", "caption", "sourceTypes", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"width", "id", "height", "enabled", "caption", "primaryStyleName", "alternateText", "resources", "description", "registeredEventListeners", "readOnly", "immediate", "errorMessage", "styles", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"tabIndex", "enabled", "primaryStyleName", "hideErrors", "propertyReadOnly", "resolution", "errorMessage", "description", "modified", "height", "id", "required", "styles", "width", "value", "orientation", "readOnly", "minValue", "resources", "immediate", "maxValue", "registeredEventListeners", "caption", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"resources", "enabled", "immediate", "id", "childLocations", "templateName", "height", "description", "errorMessage", "styles", "registeredEventListeners", "templateContents", "primaryStyleName", "width", "caption", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"caption", "resources", "registeredEventListeners", "primaryStyleName", "errorMessage", "styles", "height", "readOnly", "id", "description", "enabled", "immediate", "width", "alternateText", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"width", "description", "resources", "errorMessage", "caption", "text", "height", "styles", "readOnly", "enabled", "id", "primaryStyleName", "registeredEventListeners", "contentMode", "immediate", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"readOnly", "primaryStyleName", "height", "caption", "enabled", "resources", "hideErrors", "width", "errorMessage", "registeredEventListeners", "propertyReadOnly", "required", "immediate", "styles", "id", "tabIndex", "modified", "description", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"caption", "enabled", "width", "resources", "tabIndex", "errorMessage", "immediate", "id", "primaryStyleName", "readOnly", "registeredEventListeners", "description", "height", "styles", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"enabled", "caption", "width", "resources", "height", "description", "id", "readOnly", "registeredEventListeners", "immediate", "primaryStyleName", "errorMessage", "styles", });
            ...
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"readOnly", "immediate", "registeredEventListeners", "description", "primaryStyleName", "styles", "errorMessage", "width", "height", "id", "resources", "caption", "enabled", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"height", "errorMessage", "muted", "width", "resources", "caption", "showControls", "htmlContentAllowed", "id", "enabled", "styles", "sources", "description", "autoplay", "immediate", "readOnly", "registeredEventListeners", "altText", "primaryStyleName", "sourceTypes", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"height", "styles", "caption", "immediate", "id", "enabled", "description", "registeredEventListeners", "primaryStyleName", "errorMessage", "width", "resources", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"minPositionUnit", "maxPositionUnit", "position", "positionUnit", "locked", "maxPosition", "positionReversed", "minPosition", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"readOnly", "registeredEventListeners", "height", "description", "tabIndex", "enabled", "caption", "styles", "modified", "immediate", "errorMessage", "primaryStyleName", "hideErrors", "id", "width", "required", "resources", "propertyReadOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"primaryStyleName", "modified", "readOnly", "id", "text", "description", "rows", "wordwrap", "enabled", "propertyReadOnly", "immediate", "registeredEventListeners", "tabIndex", "columns", "resources", "hideErrors", "required", "inputPrompt", "width", "height", "caption", "styles", "errorMessage", "maxLength", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"enabled", "readOnly", "id", "description", "width", "disableOnClick", "htmlContentAllowed", "primaryStyleName", "height", "immediate", "tabIndex", "caption", "styles", "registeredEventListeners", "clickShortcutKeyCode", "resources", "errorMessage", });
            ...
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"enabled", "width", "indeterminate", "modified", "height", "state", "registeredEventListeners", "hideErrors", "resources", "errorMessage", "caption", "pollingInterval", "required", "readOnly", "propertyReadOnly", "immediate", "tabIndex", "description", "id", "primaryStyleName", "styles", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"hideErrors", "tabIndex", "readOnly", "description", "primaryStyleName", "height", "resources", "errorMessage", "id", "caption", "modified", "enabled", "immediate", "registeredEventListeners", "width", "propertyReadOnly", "styles", "required", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"secondChild", "errorMessage", "splitterState", "height", "registeredEventListeners", "caption", "immediate", "readOnly", "description", "enabled", "id", "primaryStyleName", "firstChild", "resources", "width", "styles", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"readOnly", "errorMessage", "tabIndex", "width", "primaryStyleName", "immediate", "scrollLeft", "registeredEventListeners", "caption", "resources", "description", "height", "id", "enabled", "scrollTop", "styles", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"connectorToCssPosition", "registeredEventListeners", "errorMessage", "readOnly", "description", "enabled", "immediate", "width", "styles", "height", "id", "primaryStyleName", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"height", "propertyReadOnly", "footer", "id", "layout", "immediate", "width", "errorMessage", "caption", "readOnly", "resources", "primaryStyleName", "tabIndex", "description", "enabled", "required", "modified", "registeredEventListeners", "styles", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"resources", "uriFragment", "height", "width", "description", "caption", "id", "immediate", "parameters", "primaryStyleName", "registeredEventListeners", "features", "target", "readOnly", "enabled", "styles", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"propertyReadOnly", "description", "tabIndex", "width", "id", "height", "enabled", "maxLength", "readOnly", "immediate", "caption", "columns", "required", "registeredEventListeners", "inputPrompt", "modified", "errorMessage", "text", "resources", "styles", "primaryStyleName", "hideErrors", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"errorMessage", "caption", "styles", "height", "id", "registeredEventListeners", "immediate", "bgColor", "primaryStyleName", "description", "cursorX", "cursorY", "readOnly", "enabled", "resources", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"color", "primaryStyleName", "id", "htmlContentAllowed", "width", "resources", "readOnly", "styles", "immediate", "enabled", "showDefaultCaption", "registeredEventListeners", "popupVisible", "errorMessage", "height", "description", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"errorMessage", "changedX", "id", "changedY", "primaryStyleName", "enabled", "immediate", "width", "description", "rowCount", "readOnly", "resources", "caption", "columnCount", "changedColor", "height", "registeredEventListeners", "styles", });
