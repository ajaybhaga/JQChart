...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Audio","com.vaadin.ui.DateField","com.vaadin.ui.Label","com.vaadin.ui.CheckBox","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.TextField","com.vaadin.ui.ListSelect","com.vaadin.ui.JavaScript","com.vaadin.ui.BrowserFrame","com.vaadin.ui.CustomLayout","com.vaadin.ui.CssLayout","com.vaadin.ui.MenuBar","com.vaadin.ui.UI","com.vaadin.ui.Upload","com.vaadin.ui.InlineDateField","com.vaadin.ui.PasswordField","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Video","com.vaadin.ui.TabSheet","com.vaadin.ui.Accordion","com.vaadin.ui.Tree","com.vaadin.ui.TreeTable","com.vaadin.ui.Table","com.cs.Chart","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.PopupView","com.vaadin.ui.Image","com.vaadin.server.BrowserWindowOpener","com.vaadin.server.FileDownloader","com.vaadin.ui.OptionGroup","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.FormLayout","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Slider","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.VerticalLayout","com.vaadin.ui.GridLayout","com.vaadin.ui.Button","com.vaadin.ui.Panel","com.vaadin.ui.NativeButton","com.vaadin.ui.CustomComponent","com.vaadin.ui.Form","com.vaadin.ui.Link","com.vaadin.ui.ComboBox","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Flash","com.vaadin.ui.Embedded","com.vaadin.ui.TextArea","com.vaadin.ui.Window","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.NativeSelect","com.vaadin.ui.CustomField",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"hideErrors", "propertyReadOnly", "required", "styles", "description", "caption", "tabIndex", "height", "width", "id", "enabled", "errorMessage", "resources", "textFieldEnabled", "readOnly", "modified", "immediate", "primaryStyleName", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"errorMessage", "tabIndex", "rows", "maxLength", "description", "modified", "enabled", "required", "id", "styles", "inputPrompt", "width", "caption", "columns", "wordwrap", "height", "text", "propertyReadOnly", "primaryStyleName", "resources", "hideErrors", "registeredEventListeners", "readOnly", "immediate", });
            ...
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"required", "registeredEventListeners", "resolution", "tabIndex", "minValue", "resources", "immediate", "caption", "description", "propertyReadOnly", "maxValue", "orientation", "width", "height", "hideErrors", "readOnly", "primaryStyleName", "errorMessage", "enabled", "styles", "modified", "id", "value", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"registeredEventListeners", "immediate", "readOnly", "id", "errorMessage", "tabIndex", "height", "description", "styles", "resources", "caption", "primaryStyleName", "htmlContentAllowed", "clickShortcutKeyCode", "enabled", "disableOnClick", "width", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"resources", "styles", "primaryStyleName", "height", "width", "description", "enabled", "immediate", "modified", "hideErrors", "id", "errorMessage", "tabIndex", "required", "caption", "propertyReadOnly", "readOnly", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"errorMessage", "sourceTypes", "styles", "height", "altText", "autoplay", "resources", "enabled", "primaryStyleName", "width", "showControls", "sources", "registeredEventListeners", "htmlContentAllowed", "id", "readOnly", "muted", "description", "caption", "immediate", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"propertyReadOnly", "readOnly", "maxLength", "columns", "hideErrors", "description", "modified", "width", "registeredEventListeners", "text", "styles", "resources", "id", "required", "tabIndex", "primaryStyleName", "caption", "inputPrompt", "height", "errorMessage", "immediate", "enabled", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row2", "row1", "alignment", "column2", "column1", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"immediate", "height", "primaryStyleName", "errorMessage", "childData", "marginsBitmask", "id", "enabled", "description", "readOnly", "resources", "width", "registeredEventListeners", "spacing", "caption", "styles", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"immediate", "readOnly", "resources", "modified", "propertyReadOnly", "indeterminate", "id", "state", "tabIndex", "hideErrors", "width", "caption", "height", "styles", "pollingInterval", "errorMessage", "registeredEventListeners", "enabled", "primaryStyleName", "description", "required", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"height", "caption", "resources", "primaryStyleName", "errorMessage", "registeredEventListeners", "modified", "required", "immediate", "hideErrors", "propertyReadOnly", "id", "readOnly", "tabIndex", "enabled", "width", "description", "styles", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"enabled", "names", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"description", "immediate", "registeredEventListeners", "caption", "target", "readOnly", "enabled", "uriFragment", "features", "width", "height", "styles", "resources", "parameters", "errorMessage", "primaryStyleName", "id", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"hideErrors", "required", "errorMessage", "readOnly", "id", "propertyReadOnly", "height", "resources", "enabled", "primaryStyleName", "tabIndex", "immediate", "description", "styles", "width", "modified", "caption", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"width", "readOnly", "resources", "caption", "primaryStyleName", "connectorToCssPosition", "height", "registeredEventListeners", "id", "styles", "errorMessage", "immediate", "description", "enabled", });
            store.setProperties(com.cs.gwt.client.shared.JQChartState.class, new String[] {"frameHeight", "resources", "initJS", "registeredEventListeners", "enabled", "refreshJS", "uuid", "width", "errorMessage", "primaryStyleName", "id", "immediate", "description", "styles", "height", "clickJS", "chartWidth", "dataClickJS", "caption", "frameWidth", "readOnly", "chartHeight", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"tabIndex", "required", "resources", "height", "propertyReadOnly", "enabled", "modified", "primaryStyleName", "immediate", "hideErrors", "id", "registeredEventListeners", "styles", "description", "caption", "errorMessage", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "callbackNames", "enabled", "registeredEventListeners", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"resources", "description", "caption", "width", "readOnly", "primaryStyleName", "errorMessage", "alternateText", "id", "height", "styles", "immediate", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"resources", "height", "primaryStyleName", "registeredEventListeners", "immediate", "id", "spacing", "description", "width", "styles", "enabled", "errorMessage", "marginsBitmask", "caption", "childData", "readOnly", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"registeredEventListeners", "resources", "hideErrors", "required", "width", "caption", "enabled", "height", "immediate", "modified", "styles", "errorMessage", "propertyReadOnly", "primaryStyleName", "id", "readOnly", "description", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"readOnly", "height", "marginsBitmask", "id", "enabled", "width", "errorMessage", "description", "spacing", "caption", "styles", "columns", "rows", "childData", "resources", "primaryStyleName", "immediate", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"registeredEventListeners", "resources", "height", "description", "tabIndex", "readOnly", "errorMessage", "styles", "enabled", "width", "caption", "id", "immediate", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"width", "readOnly", "caption", "propertyReadOnly", "tabIndex", "registeredEventListeners", "hideErrors", "styles", "resources", "primaryStyleName", "immediate", "required", "description", "height", "errorMessage", "id", "enabled", "modified", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"caption", "resources", "errorMessage", "height", "hideOnMouseOut", "id", "immediate", "primaryStyleName", "description", "html", "registeredEventListeners", "enabled", "width", "styles", "readOnly", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"readOnly", "registeredEventListeners", "caption", "height", "enabled", "resources", "errorMessage", "immediate", "width", "description", "primaryStyleName", "childCss", "id", "styles", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"resources", "caption", "styles", "enabled", "readOnly", "errorMessage", "height", "id", "primaryStyleName", "width", "immediate", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"immediate", "id", "primaryStyleName", "errorMessage", "enabled", "readOnly", "height", "registeredEventListeners", "caption", "resources", "styles", "description", "width", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"width", "alternateText", "height", "primaryStyleName", "enabled", "readOnly", "errorMessage", "resources", "styles", "caption", "immediate", "id", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"altKey", "clientX", "button", "clientY", "relativeX", "relativeY", "type", "ctrlKey", "shiftKey", "metaKey", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "width", "immediate", "errorMessage", "description", "resources", "caption", "enabled", "registeredEventListeners", "htmlContentAllowed", "clickShortcutKeyCode", "id", "readOnly", "styles", "disableOnClick", "tabIndex", "height", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"errorMessage", "modal", "scrollLeft", "primaryStyleName", "description", "centered", "readOnly", "tabIndex", "positionX", "width", "id", "positionY", "caption", "draggable", "resizeLazy", "scrollTop", "styles", "resizable", "registeredEventListeners", "enabled", "resources", "immediate", "height", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"enabled", "width", "id", "immediate", "registeredEventListeners", "height", "styles", "resources", "errorMessage", "primaryStyleName", "description", "readOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"id", "primaryStyleName", "height", "enabled", "caption", "immediate", "resources", "modified", "tabIndex", "errorMessage", "hideErrors", "styles", "description", "registeredEventListeners", "readOnly", "width", "required", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"description", "registeredEventListeners", "caption", "enabled", "resources", "height", "secondChild", "styles", "firstChild", "width", "readOnly", "id", "splitterState", "errorMessage", "primaryStyleName", "immediate", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"readOnly", "height", "description", "text", "errorMessage", "id", "immediate", "primaryStyleName", "registeredEventListeners", "styles", "enabled", "resources", "contentMode", "caption", "width", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"embedParams", "description", "height", "registeredEventListeners", "classId", "archive", "styles", "resources", "codetype", "errorMessage", "caption", "standby", "alternateText", "readOnly", "id", "enabled", "immediate", "codebase", "primaryStyleName", "width", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"styles", "enabled", "primaryStyleName", "immediate", "readOnly", "width", "errorMessage", "registeredEventListeners", "spacing", "resources", "caption", "id", "description", "childData", "marginsBitmask", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "positionUnit", "maxPosition", "minPositionUnit", "locked", "minPosition", "maxPositionUnit", "position", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"caption", "propertyReadOnly", "required", "modified", "enabled", "hideErrors", "readOnly", "styles", "primaryStyleName", "registeredEventListeners", "tabIndex", "id", "resources", "immediate", "width", "description", "errorMessage", "height", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"errorMessage", "width", "registeredEventListeners", "propertyReadOnly", "required", "height", "hideErrors", "resources", "readOnly", "primaryStyleName", "caption", "modified", "immediate", "id", "enabled", "checked", "tabIndex", "description", "styles", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"enabled", "splitterState", "id", "immediate", "styles", "errorMessage", "registeredEventListeners", "resources", "description", "caption", "secondChild", "width", "primaryStyleName", "readOnly", "firstChild", "height", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"errorMessage", "registeredEventListeners", "resources", "modified", "layout", "width", "caption", "hideErrors", "height", "styles", "description", "readOnly", "immediate", "required", "primaryStyleName", "tabIndex", "enabled", "propertyReadOnly", "footer", "id", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"height", "caption", "id", "templateContents", "childLocations", "resources", "readOnly", "immediate", "templateName", "description", "registeredEventListeners", "styles", "primaryStyleName", "enabled", "width", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollTop", "errorMessage", "styles", "enabled", "registeredEventListeners", "readOnly", "description", "scrollLeft", "immediate", "primaryStyleName", "resources", "tabIndex", "height", "id", "width", "caption", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"styles", "description", "caption", "primaryStyleName", "errorMessage", "immediate", "registeredEventListeners", "enabled", "width", "callbackNames", "readOnly", "resources", "id", "height", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"registeredEventListeners", "htmlContentAllowed", "sourceTypes", "resources", "autoplay", "id", "primaryStyleName", "caption", "showControls", "description", "styles", "readOnly", "errorMessage", "muted", "sources", "width", "altText", "enabled", "immediate", "height", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"id", "readOnly", "width", "height", "primaryStyleName", "errorMessage", "alternateText", "caption", "styles", "immediate", "enabled", "registeredEventListeners", "description", "resources", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"errorMessage", "height", "id", "immediate", "enabled", "registeredEventListeners", "width", "readOnly", "caption", "description", "resources", "styles", "primaryStyleName", });
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "frameHeight", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "chartHeight", new Type(java.lang.String.class));
          ...
          private void load4() {
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "chartWidth", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "frameWidth", new Type(java.lang.String.class));
          ...
          private void load6() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "frameHeight", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).frameHeight = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load7() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "chartHeight", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).chartHeight = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load10() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "chartWidth", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).chartWidth = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load11() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "frameWidth", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).frameWidth = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load14() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "frameHeight", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).frameHeight;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "chartHeight", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).chartHeight;
              }
            });
          ...
          private void load17() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "chartWidth", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).chartWidth;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "frameWidth", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).frameWidth;
              }
            });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"description", "styles", "enabled", "readOnly", "errorMessage", "primaryStyleName", "cursorX", "cursorY", "bgColor", "id", "height", "registeredEventListeners", "immediate", "caption", "width", "resources", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"color", "showDefaultCaption", "registeredEventListeners", "errorMessage", "popupVisible", "height", "readOnly", "htmlContentAllowed", "caption", "id", "enabled", "styles", "description", "resources", "width", "immediate", "primaryStyleName", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"changedX", "columnCount", "changedY", "styles", "registeredEventListeners", "id", "errorMessage", "primaryStyleName", "readOnly", "caption", "width", "changedColor", "description", "rowCount", "resources", "enabled", "immediate", "height", });
